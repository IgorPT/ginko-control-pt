...
{
	var e = $(".dragplaceholder").html();
	if (e != window.dragplaceholderHtml)
	{
		saveLayout();
		window.dragplaceholderHtml = e
	}
}
...
{
	var e = $(".dragplaceholder #myAccordion");
	var t = randomNumber();
	var n = "panel-" + t;
	var r;
	e.attr("id", n);
...
{
	var e = $(".dragplaceholder #myCarousel");
	var t = randomNumber();
	var n = "carousel-" + t;
	e.attr("id", n);
...
{
	var e = $(".dragplaceholder #myModalLink");
	var t = randomNumber();
...
{
	var e = "";
	$("#download-layout").children().html($(".dragplaceholder").html());
